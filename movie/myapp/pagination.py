...
class Pagination(object):
    ...
    def html(self):
        ...
        if self.page < self.total_page_count:
            ...
            next_page = '<li class="page-item disabled"><a class="page-link" href="?{}">下一页</a></li>'.format(self.query_dict.urlencode())
        ...
        <li class="page-item">
            <form style="float:left;margin-left: -1px" method="get">
                <input name="page" 
                       ...
                       type="text" class="form-control" placeholder="页码" aria-label="页码">
